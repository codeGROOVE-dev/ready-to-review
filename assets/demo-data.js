  ...
  pullRequests: {
    incoming: [
      {
        ...
        labels: [{ name: "kind/bug" }, { name: "priority/critical" }, { name: "sig/node" }],
      ...
      },
      {
        ...
        labels: [{ name: "blocked on you" }, { name: "bug" }, { name: "terraform" }],
      ...
      },
      {
        ...
        labels: [{ name: "stale" }, { name: "security" }, { name: "terraform" }],
        repository_url: "https://api.github.com/repos/my-company/infrastructure",
    ...
    outgoing: [
      ...
      },
      {
        ...
        labels: [{ name: "performance" }, { name: "react" }, { name: "ready-to-merge" }],
        repository_url: "https://api.github.com/repos/my-company/frontend-app",
      ...
      },
      {
        ...
        labels: [{ name: "refactor" }, { name: "terraform" }, { name: "gcp" }],
        repository_url: "https://api.github.com/repos/my-company/infrastructure",
      ...
      },
      {
        ...
        requested_reviewers: [],
        labels: [{ name: "draft" }, { name: "golang" }, { name: "performance" }],
        repository_url: "https://api.github.com/repos/my-company/api-gateway",
      ...
      },
      {
        ...
        requested_reviewers: [],
        labels: [{ name: "draft" }, { name: "security" }, { name: "terraform" }, { name: "gcp" }],
        repository_url: "https://api.github.com/repos/my-company/infrastructure",
